...
{
public:
	static Dictionary* CreateDict(){ return new EUC_IDX_Dictionary();}
private:
...
{
	public:
		static Dictionary* CreateDict(){ return new EUC_MEM_Dictionary();}
private:
  void search (KANJI *key,int length);
};
...
{
	public:
		static Dictionary* CreateDict(){ return new MIX_IDX_Dictionary();}
private:
  void search (KANJI *key,int length);
};
...
{
	public:
		static Dictionary* CreateDict(){ return new MIX_MEM_Dictionary();}
private:
  void search (KANJI *key,int length);
};
...
{
	public:
		static Dictionary* CreateDict(){ return new UTF_IDX_Dictionary();}
private:
  void search (KANJI *key,int length);
};
...
{
	public:
		static Dictionary* CreateDict(){ return new UTF_MEM_Dictionary();}
private:
  void search (KANJI *key,int length);
};
